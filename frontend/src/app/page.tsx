...
export default function Home() {
  ...
  const handleRecovery = async (meetingId: string) => {
    try {
      ...
      if (result.success) {
        toast.success(t('recordingArea.recovery.successTitle'), {
          description: result.audioRecoveryStatus?.status === 'success'
            ? t('recordingArea.recovery.successWithAudio')
            : t('recordingArea.recovery.successWithoutAudio'),
          action: result.meetingId ? {
            label: t('recordingArea.common.viewMeeting'),
            onClick: () => {
      ...
      toast.error(t('recordingArea.recovery.errorTitle'), {
        description: error instanceof Error ? error.message : t('recordingArea.common.unknownErrorOccurred'),
      });
      throw error;
    }
  };
