      ...
      <div className="flex items-start justify-between w-full">
        <div className="flex-1">
          <AlertTitle className="text-yellow-900 font-semibold">
            {t('recordingArea.bluetooth.title')}
          </AlertTitle>
          <AlertDescription className="text-yellow-800 mt-1">
            <Trans
              i18nKey="recordingArea.bluetooth.description"
            ...
            >
              {t('recordingArea.bluetooth.learnMore')}
            </a>
          </AlertDescription>
        </div>
        <Button
          ...
          aria-label={t('recordingArea.bluetooth.dismiss')}
        >
          <X className="h-4 w-4" />
        </Button>
      </div>
