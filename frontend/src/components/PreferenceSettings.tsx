...
export function PreferenceSettings() {
  ...
  if (isLoadingPreferences && !notificationSettings && !storageLocations) {
    return <div className="max-w-2xl mx-auto p-6">{t('settingsArea.preferences.loading')}</div>
  }
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg border border-gray-200 p-6 shadow-sm">
        <div className="flex items-center justify-between">
          <div>
            <h3 className="text-lg font-semibold text-gray-900 mb-2">{t('settings.general.notifications.title')}</h3>
            <p className="text-sm text-gray-600">{t('settings.general.notifications.description')}</p>
          </div>
      ...
      <div className="bg-white rounded-lg border border-gray-200 p-6 shadow-sm">
        <h3 className="text-lg font-semibold text-gray-900 mb-4">{t('settingsArea.preferences.storage.title')}</h3>
        <p className="text-sm text-gray-600 mb-6">
          {t('settingsArea.preferences.storage.description')}
        </p>
        ...
        <div className="space-y-4">
          ...
          {/* Recordings Location */}
          <div className="p-4 border rounded-lg bg-gray-50">
            <div className="font-medium mb-2">{t('settingsArea.preferences.storage.recordings')}</div>
            <div className="text-sm text-gray-600 mb-3 break-all font-mono text-xs">
              {storageLocations?.recordings || t('settingsArea.common.loading')}
            </div>
            <button
