...
export function SummaryPanel({
  ...
  const effectiveLangLabel = summaryLang ? labelForCode(summaryLang) : t('meetingArea.summary.language.auto');
  const isLocalFallbackLanguage = summaryLangStorage === 'local_fallback';
  const autoSubtitle = isLocalFallbackLanguage
    ? t('meetingArea.summary.language.autoSubtitleLocal')
    : t('meetingArea.summary.language.autoSubtitleDefault');
  ...
  useEffect(() => {
    ...
    const loadSummaryLanguage = async () => {
      try {
        ...
        toast.warning(t('meetingArea.summary.language.loadFailedTitle'), {
          description: t('meetingArea.summary.language.loadFailedDescription'),
        });
        ...
        try {
          ...
          if (
            ...
            if (saved.storage === 'local_fallback') {
              toast.info(t('meetingArea.summary.language.savedLocallyTitle'), {
                description: t('meetingArea.summary.language.savedLocallyDescription'),
              });
            }
            if (request.language) {
          ...
          if (
            ...
            toast.error(t('meetingArea.summary.language.saveFailed'));
      ...
      <PopoverTrigger asChild>
        <Button
          ...
          title={isLocalFallbackLanguage
            ? t('meetingArea.summary.language.buttonTitleLocal', { language: effectiveLangLabel })
            : t('meetingArea.summary.language.buttonTitle', { language: effectiveLangLabel })}
          aria-label={t('meetingArea.summary.language.ariaLabel')}
        >
          <Languages size={18} />
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="flex items-center justify-center flex-1">
            <div className="text-center">
              ...
              <p className="text-gray-600">{t('meetingArea.summary.generatingSpinner')}</p>
            </div>
          </div>
        </div>
      ) : !aiSummary ? (
        ...
        <div className="flex-1 overflow-y-auto min-h-0">
          {summaryResponse && (
            <div className="fixed bottom-0 left-0 right-0 bg-white shadow-lg p-4 max-h-1/3 overflow-y-auto">
              <h3 className="text-lg font-semibold mb-2">{t('meetingArea.summary.response.title')}</h3>
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-white p-4 rounded-lg shadow-sm">
                  <h4 className="font-medium mb-1">{t('meetingArea.summary.response.keyPoints')}</h4>
                ...
                <div className="bg-white p-4 rounded-lg shadow-sm mt-4">
                  <h4 className="font-medium mb-1">{t('meetingArea.summary.response.actionItems')}</h4>
                  <ul className="list-disc pl-4">
                ...
                <div className="bg-white p-4 rounded-lg shadow-sm mt-4">
                  <h4 className="font-medium mb-1">{t('meetingArea.summary.response.decisions')}</h4>
                  <ul className="list-disc pl-4">
                ...
                <div className="bg-white p-4 rounded-lg shadow-sm mt-4">
                  <h4 className="font-medium mb-1">{t('meetingArea.summary.response.mainTopics')}</h4>
                  <ul className="list-disc pl-4">
              ...
              {summaryResponse.raw_summary ? (
                <div className="mt-4">
                  <h4 className="font-medium mb-1">{t('meetingArea.summary.response.fullSummary')}</h4>
