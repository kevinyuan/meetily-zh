        ...
        <div className="flex-1">
          <div className="flex items-center gap-2 mb-1">
            ...
            <h3 className="text-sm font-semibold text-blue-900">
              {t('onboardingArea.dialogs.database.homebrew.title')}
            </h3>
          </div>
          <p className="text-sm text-blue-800 mb-2">
            {t('onboardingArea.dialogs.database.homebrew.description')}
          </p>
          <div className="bg-white/50 rounded p-2 mb-3">
            ...
            <p className="text-xs text-blue-600 mt-1">
              {t('onboardingArea.dialogs.database.homebrew.size', { size: formatFileSize(dbSize) })}
            </p>
          </div>
          <p className="text-sm text-blue-800 mb-3">
            {t('onboardingArea.dialogs.database.homebrew.question')}
          </p>
          ...
          <div className="flex gap-2">
            ...
            >
              {isImporting ? (
                <>
                  ...
                  <span>{t('onboardingArea.dialogs.database.homebrew.importing')}</span>
                </>
              ) : (
                <>
                  <CheckCircle2 className="h-4 w-4" />
                  <span>{t('onboardingArea.dialogs.database.homebrew.confirm')}</span>
                </>
              )}
            </button>
            ...
            >
              {t('onboardingArea.dialogs.database.homebrew.decline')}
            </button>
          </div>
        </div>
      </div>
